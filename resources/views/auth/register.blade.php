                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group{{ $errors->has('national_code') ? ' has-error' : '' }}">
                            <label for="national_code" class="col-md-4 control-label">National Code</label>

                            <div class="col-md-6">
                                <input id="national_code" type="text" class="form-control" name="national_code" value="{{ old('national_code') }}" required>
